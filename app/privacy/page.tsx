    ...
    <LegalPage
      ...
      sections={[
          ...
          body: (
            <>
              ...
              <ul>
                ...
                <li><strong>Partner organizations</strong> such as CertainPath or Blue Collar Success Group, limited to confirming that a member used the program, and only where that is part of the member benefit. [Confirm what, if anything, is reported back to partners.]</li>
        ...
        },
        {
          ...
          body: (
            <>
              <p>Statements are stored in access-controlled systems, and we limit who at 321 Swipe can open them. The site and its forms use HTTPS. We ask you to send statements through the upload portal or a rep&apos;s form rather than posting them in the chat, and never to send full card or bank account numbers by any channel.</p>
